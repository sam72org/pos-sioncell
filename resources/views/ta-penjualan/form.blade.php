                        ...
                        ?>
                          <tr>
                            ...
                            <td style="text-align: right; width: 12%;">
                              <input style="text-align: right;" type="text" name="hargaJual" data-id="<?= $data->id ?>" data-jual="<?= $value['harga'] ?>" data-nego="<?= $data->harga_nego ?>" value="{{ number_format($value['harga'],0,',','.') }}" class="form-control dataHargaJual" id="dataHargaJual-<?= $data->id ?>" autocomplete="off">
                              
                              <!-- <input type="text" id="harga_jual2" value="{{ number_format($value['harga'],0,',','.') }}" class="form-control money"> -->
                            </td>
            ...
            <div class="box-body">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <!-- <button class="btn btn-flat btn-danger pull-right" id="" style="margin-right: -10px; margin-bottom: 10px;"><i class="fa fa-close"></i> Cancel</button> -->
                  <button class="btn btn-flat btn-primary pull-right" id="btnSavePenjualan" style="margin-right: -10px; margin-bottom: 10px;"><i class="fa fa-save"></i> Simpan Transaksi</button>
                </div>
              </div>
            </div>
        </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align: center;">
                  ...
                  <?php else: ?>
                    <button class="btn btn-sm btn-success btn-pilih-penjualan" data-id="{{ $data->id }}" data-barcode="{{ $data->kode_barcode }}" data-barang="{{ $data->nama_barang }}" data-beli="{{ $data->harga_beli }}" data-jual="{{ $data->harga_jual }}" data-nego="{{ $data->harga_nego }}" data-stok="{{ $data->stok }}" title="Pilih">

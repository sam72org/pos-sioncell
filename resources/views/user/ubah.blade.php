            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ url('user/update').'/'.$model->id }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" name="name" value="{{ $model->name }}" required autocomplete="off">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    ...
                                    <a href="{{ url('/user/index') }}" class="btn btn-danger">Batal</a>
                                </div>
                            </div>
                        </form>
                    </div>

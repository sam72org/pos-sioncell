        ...
        <div class="box-header with-border">
            ...
            <div class="row">
                <form action="" method="post">
                    ...
                    <div class="col-md-2">
                        <button class="btn btn-flat btn-primary" id="btn_laporan_cari_jasa"><i class="fa fa-search"></i> Tampilkan</button>

                        <input type="hidden" id="tgl-awal">
                        <input type="hidden" id="tgl-akhir">
                        <button class="btn btn-flat btn-warning" id="btn_print_penjualan_jasa"><i class="fa fa-print"></i> Print</button>
                    </div>
                </form>
            </div>
        </div>

        <div class="box-body" id="data-penjualan-jasa">
...
$(document).on('click', '#btn_laporan_cari_jasa', function(e) {
    e.preventDefault();
    ...
    if (tgl_awal == '') {
        ...
        $.ajax({
            type: "GET",
            url: "get-penjualan-jasa",
            data: {
                'tgl_awal' : tgl_awal,
                'tgl_akhir' : tgl_akhir,
            },
            success: function(data) {
                $('#data-penjualan-jasa').html(data.html);
            },
        });
    }
});

$(document).on('click', '#btn_print_penjualan_jasa', function(e) {
    e.preventDefault();
    ...
    if (tgl_awal == '') {
        ...
        window.open('print-penjualan-jasa/' + tgl_awal + '/' + tgl_akhir, '_blank');
    }
});
